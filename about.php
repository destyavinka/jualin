...
<head>
	<meta charset="utf-8">
	<title>About Us | JUAL.IN</title>
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<link rel="icon" href="i/jual.in.png" type="image/x-icon">
	<!-- Google Fonts -->
...
<body>
	<!-- Header 1 -->
	<header class="bg-light header_1 pt-155">
				...
				<div class="row justify-content-center align-items-center f-18 medium">
					<div class="col-lg-3">
						<a href="#" class="link img_link">
							<img src="images/profile.png" alt="Logo" class="img-fluid" data-aos="fade-down" data-aos-delay="1000">
						</a>
					</div>
					<div class="col-lg-6 text-center" data-aos="fade-down" data-aos-delay="">
		...
		<div class="container">
			<div class="mb-3 text-center d-block d-xl-none">
				<a href="#" class="link img_link">
					<img src="images/profile.png" alt="Logo" class="img-fluid" data-aos="fade-down" data-aos-delay="0">
				</a>
			</div>
			<h1 class="pt-30 big text-center" data-aos="fade-down" data-aos-delay="0">
				Solobarcode Computama
			</h1>
			<div class="pt-30 mw-550 mx-auto color-heading text-center text-adaptive row f-22 mt-4" data-aos="fade-down" data-aos-delay="250">
				adalah toko online Indonesia dengan wujud sebuah shopping online yang melayani pembelian peralatan Barcode, AIDC, Mesin Absen, Printer IDCARD, Passbook, Peralatan Kasir, RFID dan sejenisnya.
				<br>Kami juga memiliki Showroom di Komplek Ruko Kopassus Group 2 Kartasura. Tepatnya di Jl.Solo-Jogja disamping Kolam renang Kopassus Kandang Menjangan.
			</div>

		</div>
	</header>
	<!-- Navigation 1 -->
	<nav class="pt-30 bg-light text-center navigation_1 pb-30">
		<div class="container px-xl-0">
			<div class="row justify-content-center align-items-center f-16">
				<div class="mb-20 mb-lg-0 col-lg-3 text-lg-left">
				</div>
				<div class="col-lg-6" data-aos="fade-down" data-aos-delay="750">



					<a class="mx-15 link color-main img_link" target="_blank" href="https://web.whatsapp.com/">
						<i class="fab fa-whatsapp">
						</i>
					</a>
					<a class="mx-15 link color-main img_link" href="https://www.instagram.com/" target="_blank">
						<i class="fab fa-instagram">
						</i>
					</a>
					<a href="https://g.page/solobarcode-indonesia?share" class="mx-15 link color-main img_link" target="_blank">
